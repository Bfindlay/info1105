...
public class AssignmentTest {
	...
	public void testRemove2() {
		...
		t.put("GATGATGATGATGAT", "Watson");
		t.put("GATGATGATGAT", "Crick");

		t.remove("GATGATGATGATGAT");
		assertEquals(12, t.countPrefixes());
	}
	...
	public void testMoreGets() {
		...
		List<String> list = a.getKeysMatchingPrefix("");
